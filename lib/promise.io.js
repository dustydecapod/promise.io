...
(function() {
  ...
  PromiseSession = (function() {
    function PromiseSession(io, socket) {
      ...
      this.returnValue = __bind(this.returnValue, this);
      this.onNotify = __bind(this.onNotify, this);
      this.onExecute = __bind(this.onExecute, this);
      this.parseExports = __bind(this.parseExports, this);
      this.onAcknowledgeExports = __bind(this.onAcknowledgeExports, this);
      this.id = uuid();
      this.promises = {};
  ...
  PromiseIO = (function() {
    ...
    PromiseIO.prototype.sendExports = function() {
      var clientId, clientObj, funcs, _ref;
      funcs = [];
      _ref = this.clients;
      for (clientId in _ref) {
        clientObj = _ref[clientId];
